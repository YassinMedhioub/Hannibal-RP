...
<head>
    ...
    <title>Hannibal RP - Password Management</title>
</head>
<body>
    <header>
        <img src="images/offmaybe.gif" alt="LOGO" title="LS LOGO">
    ...
    <div class="navphone">
        <table>
            <tr>
                ...
                <th class="title"><a href="password.php" style="color: blue;">Change Password</a></th>
