...
<body>
    <h1 data-text="Hannibal RP"><span>Hannibal RP</span></h1>
    <form action="login.php" method="post">
        ...
        <a href="signup.php" class="ca" style="text-decoration:underline;">Create an account</a><br>
    </form>
</body>
